 ...
 class ViewControllerMapa: UIViewController, CLLocationManagerDelegate, MKMapViewDelegate, URLSessionDownloadDelegate, MFMessageComposeViewControllerDelegate, GIDSignInUIDelegate{
...
=======
    ...
    @IBAction func compartir(_ sender: Any) {
        ...
        //print("compartir")
>>>>>>> 0eb4423cb4be1e60235717868ead2019878e1a98
        let mensaje = msg + "https://www.google.com/maps/search/?api=1&query=\(gps.location!.coordinate.latitude),\(gps.location!.coordinate.longitude)"
        ...
        ac.setValue("Ayuda!", forKey: "subject")
